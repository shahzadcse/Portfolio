   ...
   if($.cookie('view') !== 'undefined'){
    ...
    function get_grid(){
        ...
        $('.logos-cnt').animate({opacity:0},function(){
			...
			$('.logos-cnt').parent().parent().removeClass('listView').addClass('gridView');
    ...
    function get_list(){
        ...
        $('.logos-cnt').animate({opacity:0},function(){
			...
			$('.logos-cnt').parent().removeClass().addClass('col-lg-12');
			 $('.logos-cnt').parent().parent().removeClass('gridView').addClass('listView');
	...
	leftPG = divPosGrid.left, topPG =  divPosGrid.top;
		...
		$('.logo-detail-'+logoId).find('.pointer').css({ 'left':(leftPG - 200)+'px'});
		 ...
		 var  divPosList = $(this).offset(), 
			leftPL = divPosList.left, topPL = $(this).scrollTop(); 
		 	//	$('.logo-detail-'+logoId).css({ 'top':(topPL + ht*logoId)+'px' });
			$('.logo-detail-'+logoId).find('.pointer').css({ 'left':0+'px'});
		 } 
	 
	$('.logo-detail-'+logoId).slideToggle('fast', 'linear');
